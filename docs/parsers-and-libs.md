...
slider - see [`audio.md`](features/audio.md). The DeepFilterNet3 denoise
subsystem (`dfn-*.js`) is its noise-suppression twin, reached via the
**denoise** button in the same AI model row and shown as a Clean/Noise blend.
