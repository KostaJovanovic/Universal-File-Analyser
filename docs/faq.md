...
[`user-guide.md`](user-guide.md) and the `docs/features/*.md` docs for deeper detail.
...
[`worker.md`](worker.md)) - never the file itself.
...
or [`renderers.md`](renderers.md) for the developer-facing module map.
...
[`parsers-and-libs.md`](parsers-and-libs.md) and the "Under the hood" section of the repo
...
cards" and the SVG entry in [`cross-cutting.md`](features/cross-cutting.md)/
[`design-cad-3d.md`](features/design-cad-3d.md).
...
[`images.md`](features/images.md) and [`design-cad-3d.md`](features/design-cad-3d.md).
...
recovery" in [`images.md`](features/images.md) and "Truncated/unfinalised
recording salvage" in [`video.md`](features/video.md).
...
[`architecture.md`](architecture.md) for one concrete example. Exact minimum versions per
