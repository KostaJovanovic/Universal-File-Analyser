...
export const IDENTIFICATION_CORE = [
    ...
    { label: 'Design', exts: 'FIG Sketch afphoto afdesign afpub SPP SBSAR SBS CDR MDP', tags: 'figma sketch affinity photo designer publisher gimp substance painter coreldraw cdr medibang paint mdp vector drawing', desc: 'Identify design-app files: Figma (FIG), Sketch, Affinity Photo/Designer/Publisher, CorelDRAW (CDR), MediBang Paint (MDP) and Substance. GIMP (XCF) now opens in a full viewer - see GIMP above. Krita (KRA), Procreate and Paint.NET (PDN) now show their embedded preview - see Raster art above.' },
