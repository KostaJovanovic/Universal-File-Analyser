...
const PATCH_DIGEST_NEW = [
    { range: '9.01 - 9.08', notes: [
            ...
            'A green **Get App** button at the top of every page and **Install as app** in the footer both open the latest release, and inside the apps that footer button reads **Check for updates** instead.',
        ] },
...
export function setupPatchTldr() {
    ...
    if (!section.querySelector('.patch-digest')) {
        ...
        if (firstEntry)
            firstEntry.parentNode.insertBefore(digest, firstEntry);
        else
...
//# sourceMappingURL=patch-tldr.js.map