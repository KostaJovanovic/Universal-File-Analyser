...
export const FORMATS = {
  ...
  c:       { app: 'C Source', icon: 'C', parse: 'text' },
  h:       { app: 'C / C++ Header', icon: 'H', parse: 'text' },
  cc:      { app: 'C++ Source', icon: 'CC', parse: 'text' },
  cpp:     { app: 'C++ Source', icon: 'CPP', parse: 'text' },
  cxx:     { app: 'C++ Source', icon: 'CXX', parse: 'text' },
  hpp:     { app: 'C++ Header', icon: 'HPP', parse: 'text' },
  hh:      { app: 'C++ Header', icon: 'HH', parse: 'text' },
  hxx:     { app: 'C++ Header', icon: 'HXX', parse: 'text' },
  ino:     { app: 'Arduino Sketch', icon: 'INO', parse: 'text' },
  cs:      { app: 'C# Source', icon: 'CS', parse: 'text' },
  java:    { app: 'Java Source', icon: 'JAVA', parse: 'text' },
  kt:      { app: 'Kotlin Source', icon: 'KT', parse: 'text' },
  kts:     { app: 'Kotlin Script', icon: 'KTS', parse: 'text' },
  go:      { app: 'Go Source', icon: 'GO', parse: 'text' },
  rs:      { app: 'Rust Source', icon: 'RS', parse: 'text' },
  py:      { app: 'Python Source', icon: 'PY', parse: 'text' },
  pyw:     { app: 'Python Source', icon: 'PYW', parse: 'text' },
  rb:      { app: 'Ruby Source', icon: 'RB', parse: 'text' },
  php:     { app: 'PHP Source', icon: 'PHP', parse: 'text' },
  swift:   { app: 'Swift Source', icon: 'SWFT', parse: 'text' },
  scala:   { app: 'Scala Source', icon: 'SCL', parse: 'text' },
  lua:     { app: 'Lua Script', icon: 'LUA', parse: 'text' },
  pl:      { app: 'Perl Source', icon: 'PL', parse: 'text' },
  pm:      { app: 'Perl Module', icon: 'PM', parse: 'text' },
  r:       { app: 'R Source', icon: 'R', parse: 'text' },
  dart:    { app: 'Dart Source', icon: 'DART', parse: 'text' },
  groovy:  { app: 'Groovy Source', icon: 'GVY', parse: 'text' },
  vb:      { app: 'Visual Basic Source', icon: 'VB', parse: 'text' },
  mm:      { app: 'Objective-C++ Source', icon: 'MM', parse: 'text' },
  hmm:     { app: 'Objective-C++ Header', icon: 'HMM', parse: 'text' },

  // GPU shaders (plain-text source preview)
  glsl:    { app: 'GLSL Shader', icon: 'GLSL', parse: 'text' },
  vert:    { app: 'GLSL Vertex Shader', icon: 'VERT', parse: 'text' },
  frag:    { app: 'GLSL Fragment Shader', icon: 'FRAG', parse: 'text' },
  comp:    { app: 'GLSL Compute Shader', icon: 'COMP', parse: 'text' },
  hlsl:    { app: 'HLSL Shader', icon: 'HLSL', parse: 'text' },
  fs:      { app: 'GLSL Fragment Shader', icon: 'FS', parse: 'text' },
  vs:      { app: 'GLSL Vertex Shader', icon: 'VS', parse: 'text' },
  gs:      { app: 'GLSL Geometry Shader', icon: 'GS', parse: 'text' },

  // Shell scripts (plain-text source preview)
  sh:      { app: 'Shell Script', icon: 'SH', parse: 'text' },
  bash:    { app: 'Bash Script', icon: 'BASH', parse: 'text' },
  zsh:     { app: 'Zsh Script', icon: 'ZSH', parse: 'text' },
  fish:    { app: 'Fish Script', icon: 'FISH', parse: 'text' },

  // Build systems, make and project files (plain-text source preview)
  cmake:   { app: 'CMake Script', icon: 'CMK', parse: 'text' },
  mk:      { app: 'Makefile Fragment', icon: 'MK', parse: 'text' },
  mak:     { app: 'Makefile', icon: 'MAK', parse: 'text' },
  make:    { app: 'Makefile', icon: 'MAKE', parse: 'text' },
  ninja:   { app: 'Ninja Build File', icon: 'NINJ', parse: 'text' },
  in:      { app: 'Autoconf Template', icon: 'IN', parse: 'text' },
  inc:     { app: 'Include File', icon: 'INC', parse: 'text' },
  am:      { app: 'Automake File', icon: 'AM', parse: 'text' },
  ac:      { app: 'Autoconf Script', icon: 'AC', parse: 'text' },
  m4:      { app: 'M4 Macro File', icon: 'M4', parse: 'text' },
  pro:     { app: 'qmake Project', icon: 'PRO', parse: 'text' },
  pri:     { app: 'qmake Include', icon: 'PRI', parse: 'text' },
  qrc:     { app: 'Qt Resource Collection', icon: 'QRC', parse: 'xml' },
  rc:      { app: 'Resource Script', icon: 'RC', parse: 'text' },
  def:     { app: 'Module Definition File', icon: 'DEF', parse: 'text' },
  spec:    { app: 'Spec File', icon: 'SPEC', parse: 'text' },
  dox:     { app: 'Doxygen Config', icon: 'DOX', parse: 'text' },
  doxygen: { app: 'Doxygen Config', icon: 'DOXY', parse: 'text' },
  jam:     { app: 'Boost.Jam Build Script', icon: 'JAM', parse: 'text' },
  build:   { app: 'Meson Build Script', icon: 'BLD', parse: 'text' },
  skip:    { app: 'Skipped-Test Marker', icon: 'SKIP', parse: 'text' },
  man:     { app: 'Unix Manual Page', icon: 'MAN', parse: 'text' },

  // Tool dotfiles (ignore lists, attributes, formatter / linter configs)
  gitignore:      { app: 'Git Ignore Rules', icon: 'GIT', parse: 'text' },
  gitattributes:  { app: 'Git Attributes', icon: 'GIT', parse: 'text' },
  gitmodules:     { app: 'Git Submodules', icon: 'GIT', parse: 'text' },
  dockerignore:   { app: 'Docker Ignore Rules', icon: 'DOCK', parse: 'text' },
  npmignore:      { app: 'npm Ignore Rules', icon: 'NPM', parse: 'text' },
  eslintignore:   { app: 'ESLint Ignore Rules', icon: 'ESL', parse: 'text' },
  prettierignore: { app: 'Prettier Ignore Rules', icon: 'PRET', parse: 'text' },
  cursorignore:   { app: 'Cursor Ignore Rules', icon: 'CURS', parse: 'text' },
  'clang-format': { app: 'Clang-Format Config', icon: 'CLNG', parse: 'text' },
  'clang-tidy':   { app: 'Clang-Tidy Config', icon: 'CLNG', parse: 'text' },

  // Web styles / components, localisation, manuals and licence text
  less:    { app: 'Less Stylesheet', icon: 'LESS', parse: 'text' },
  scss:    { app: 'Sass Stylesheet', icon: 'SCSS', parse: 'text' },
  svelte:  { app: 'Svelte Component', icon: 'SVLT', parse: 'text' },
  po:      { app: 'gettext Translation', icon: 'PO', parse: 'text' },
  pot:     { app: 'gettext Template', icon: 'POT', parse: 'text' },
  entitlements: { app: 'Apple Entitlements', icon: 'ENT', parse: 'xml' },
  copying: { app: 'Licence Text', icon: 'LIC', parse: 'text' },
  readme:  { app: 'Readme File', icon: 'RDME', parse: 'text' },
  lesser:  { app: 'Licence Text', icon: 'LIC', parse: 'text' },

  // More shaders, source, web and dotfiles (plain-text source preview)
  fsh:     { app: 'OpenGL Fragment Shader', icon: 'FSH', parse: 'text' },
  vsh:     { app: 'OpenGL Vertex Shader', icon: 'VSH', parse: 'text' },
  geom:    { app: 'GLSL Geometry Shader', icon: 'GEOM', parse: 'text' },
  pyx:     { app: 'Cython Source', icon: 'PYX', parse: 'text' },
  sample:  { app: 'Git Hook Sample', icon: 'HOOK', parse: 'text' },
  ...
  info:    { app: 'Info Text File', icon: 'INFO', parse: 'text' },
  inf:     { app: 'Windows Setup Information', icon: 'INF', parse: 'text' },
  lst:     { app: 'List / Index File', icon: 'LST', parse: 'text', chunk: 'osmisc' },
  lang:    { app: 'Language Strings', icon: 'LANG', parse: 'text' },
  lng:     { app: 'Language File', icon: 'LNG', parse: 'text' },

  // Project / config files that are really JSON or XML (shown as source)
  mcmeta:  { app: 'Minecraft Asset Metadata', icon: 'MCM', parse: 'text' },
  uproject: { app: 'Unreal Engine Project', icon: 'UE', parse: 'text' },
  uplugin: { app: 'Unreal Engine Plugin', icon: 'UE', parse: 'text' },
  kicad_pro: { app: 'KiCad Project', icon: 'KCAD', parse: 'text' },
  kicad_prl: { app: 'KiCad Project Local Settings', icon: 'KCAD', parse: 'text' },
  kicad_sch: { app: 'KiCad Schematic', icon: 'KCAD', parse: 'text' },
  tps:     { app: 'Unreal Third-Party Notice', icon: 'TPS', parse: 'xml' },
  browser: { app: 'ASP.NET Browser Definition', icon: 'BRWS', parse: 'xml' },

  // Game-engine binaries (identification only)
  ubulk:   { app: 'Unreal Bulk Data', icon: 'UE' },
  ufont:   { app: 'Unreal Font', icon: 'UE' },
  locmeta: { app: 'Unreal Localization Metadata', icon: 'UE' },
  locres:  { app: 'Unreal Localization Resource', icon: 'UE' },
  ushaderbytecode: { app: 'Unreal Shader Bytecode', icon: 'UE' },
  ress:    { app: 'Unity Resource Stream', icon: 'UNI' },
  bk2:     { app: 'Bink Video 2', icon: 'BK2', magic: [0x4B, 0x42, 0x32] },

  // Fonts, modules, paint, i18n data and backups (identification only)
  eot:     { app: 'Embedded OpenType Font', icon: 'EOT' },
  pyd:     { app: 'Python Extension Module', icon: 'PYD', magic: [0x4D, 0x5A] },
  mdp:     { app: 'MediBang Paint Document', icon: 'MDP' },
  icu:     { app: 'ICU Data', icon: 'ICU' },
  pdsbak:  { app: 'Proteus Design Backup', icon: 'PDS' },
  bak:     { app: 'Backup File', icon: 'BAK' },
  old:     { app: 'Backup File', icon: 'OLD' },
  ...
  djifw:   { app: 'DJI Firmware', icon: 'DJI', chunk: 'disk' },
  ...
  pln:     { app: 'Graphisoft ArchiCAD Project', icon: 'PLN', chunk: 'threed' },
  pla:     { app: 'Graphisoft ArchiCAD Archive', icon: 'PLA', chunk: 'threed' },
