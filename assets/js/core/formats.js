...
export const IDENTIFICATION_CORE = [
  { label: 'Adobe',           exts: 'INDD INDT IDML AEP AEPX AET PRPROJ PREL MOGRT SESX XD FLA SWF XMP LRtemplate LRcat ACV ACO ASL ABR GRD PAT', tags: 'photoshop illustrator indesign after effects premiere pro premiere elements audition xd animate flash lightroom substance motion graphics compositing', desc: 'Identify Adobe project files and read their metadata: InDesign (INDD), After Effects (AEP, AEPX, AET) with composition / layer / effect and asset extraction, Premiere Pro and Elements (PRPROJ, PREL) with sequence and media counts, XD, Animate (FLA), and Lightroom. Photoshop (PSD, PSB) and Illustrator (AI) now open in full viewers - see Photoshop and Illustrator.' },
