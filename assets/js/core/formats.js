...
export const IDENTIFICATION_CORE = [
  { label: 'Adobe',           exts: 'INDD INDT IDML AEPX MOGRT SESX XD FLA SWF XMP LRtemplate LRcat ACV ACO ASL ABR GRD PAT', tags: 'photoshop illustrator indesign after effects premiere pro premiere elements audition xd animate flash lightroom substance motion graphics compositing', desc: 'Identify Adobe project files and read their metadata: InDesign (INDD), the After Effects XML project (AEPX), XD, Animate (FLA), and Lightroom. After Effects projects (AEP, AET), Premiere Pro and Elements (PRPROJ, PREL), Photoshop (PSD, PSB) and Illustrator (AI) now open in full viewers - see After Effects, Premiere Pro, Photoshop and Illustrator.' },
  ...
  { label: 'Video editing',   exts: 'AEPX VEG VF WFP WSP', tags: 'adobe after effects motion graphics sony vegas magix wondershare filmora capcut bytedance video editing timeline sequence compositing vfx ndi draft_content.json', desc: 'Identify and read video-editing project files: the After Effects XML project (AEPX); Sony / MAGIX VEGAS Pro (VEG, VF); Wondershare Filmora (WFP, WSP); and CapCut drafts (draft_content.json) - canvas resolution, duration, tracks and material counts. After Effects (AEP, AET), Premiere Pro (PRPROJ, PREL) and DaVinci Resolve (DRP, DRT) projects now open in full timeline viewers - see those entries.' },
