...
export const IDENTIFICATION_CORE = [
  ...
  { label: 'Design',          exts: 'FIG Sketch afphoto afdesign afpub XCF SPP SBSAR SBS CDR', tags: 'figma sketch affinity photo designer publisher gimp substance painter coreldraw cdr vector drawing', desc: 'Identify design-app files: Figma (FIG), Sketch, Affinity Photo/Designer/Publisher, GIMP (XCF), CorelDRAW (CDR) and Substance. Krita (KRA), Procreate and Paint.NET (PDN) now show their embedded preview - see Raster art above.' },
