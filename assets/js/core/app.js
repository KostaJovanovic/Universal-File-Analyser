...
const PATCH_DIGEST = [
  { range: '5.16 - 5.19', notes: [
    ...
    'The G-code viewer’s "dim other tools" highlight now cross-fades smoothly on a tool change and eases back to full once playback finishes, and a build defaults to a fixed 30-second playback instead of real time.',
    'The per-format guide pages had a fact-checking pass: wrong dates and attributions corrected, and every file type now carries at least three verified "Did you know" facts.',
  ] },
...
window._anrReadableText = isReadableText;
  ...
  const TIERS = {
    essentials: [
      ...
      './assets/js/core/stats-page.js', './assets/js/core/history.js',
