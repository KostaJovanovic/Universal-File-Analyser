...
import { el, row, fmtBytes, loadScript } from './util.js';
import { Reader, ascii, findBytes, matchMagic, startsWithAscii, latin1, utf8 } from './binutil.js';
...
async function decodeJp2Preview(file, out) {
  try {
    const { decodeJ2K } = await import('./openjpeg-loader.js');
  ...
  try {
    ...
    (async () => {
      ...
      try {
        ...
        const { renderPostScript } = await import('./ghostscript-loader.js');
